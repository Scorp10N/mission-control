...
/*
 ...
 Environment:
   MISSION_CONTROL_URL  Base URL (default: http://localhost:3001); MC_URL accepted as alias
...
function loadConfig() {
  ...
  return {
    baseUrl: (process.env.MISSION_CONTROL_URL || process.env.MC_URL || profile.url || 'http://localhost:3001').replace(/\/+$/, ''),
